...
'DATADIR/events_nhmin_50_0.dat' u ($1**2+0.8):($2/(2*$1)) t 'Best Fit to NH data' w l lt 1 lc rgb '#006400' lw 2
...
plot \
'DATADIR/events_nh_50_6.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 2 lc rgb 'blue' lw 3 ,\
'DATADIR/events_ih_50_6.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 2 lc rgb 'red' lw 3 ,\
'DATADIR/events_nhmin_50_6.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 1 lc rgb '#006400' lw 2
...
'DATADIR/events_nhmin_30_0.dat' u ($1**2+0.8):($2/(2*$1)) t 'Best Fit to NH data' w l lt 1 lc rgb '#006400' lw 2
...
set label '{/Symbol=\144}E_{vis}/E_{vis} = 6%/{/Symbol=\326}E_{vis}' at graph 0.05, graph 0.5
plot \
'DATADIR/events_nh_30_6.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 2 lc rgb 'blue' lw 3 ,\
'DATADIR/events_ih_30_6.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 2 lc rgb 'red' lw 3 ,\
'DATADIR/events_nhmin_30_6.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 1 lc rgb '#006400' lw 2
