...
set multiplot
plot \
'DATADIR/FluxXsec_h.dat' u ($1**2+0.8):TWO notitle with histeps lt 1 lc rgb 'red' lw 3 ,\
'DATADIR/FluxXsec_h2.dat' u ($1**2+0.8):TWO notitle with points lt 1 lc rgb 'blue' lw 3
set nomultiplot
