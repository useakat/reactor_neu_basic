...
set output "plots/EventDistmin_fit2nh_combine_50_3_1.eps"
#set title "20GW_{th}, 5kton, 5 years, 50 km"
...
set format x
#set label '{/Symbol=\144}E_{vis}/E_{vis} = 3%/{/Symbol=\326}E_{vis} +1%' at graph 0.05, graph 0.5
set label '(a, b) = (3, 1)%' at graph 0.05, graph 0.5
plot \
'rslt_test/data/events_nh_50_3_1.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 2 lc rgb 'blue' lw 3 ,\
'rslt_test/data/events_ih_50_3_1.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 2 lc rgb 'red' lw 3 ,\
'rslt_test/data/events_nhmin_50_3_1.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 1 lc rgb '#006400' lw 2
