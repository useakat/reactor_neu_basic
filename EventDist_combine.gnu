...
unset title
#set title '{/=20 20GW_{th}, 5kton, 5 years, {/Symbol=\144}E_{vis}/E_{vis} = 0%/{/Symbol=\326}E_{vis}}'
set size 1,0.98
...
plot \
'rslt_P20V5R12Y5/data/events_nh_30_0.dat' u ($1**2+0.8):($2/(2*$1)) t '30 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'rslt_P20V5R12Y5/data/events_ih_30_0.dat' u ($1**2+0.8):($2/(2*$1)) t '      IH'  w l lt 1 lc rgb 'red' lw 1
...
plot \
'rslt_P20V5R12Y5/data/events_nh_40_0.dat' u ($1**2+0.8):($2/(2*$1)) t '40 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'rslt_P20V5R12Y5/data/events_ih_40_0.dat' u ($1**2+0.8):($2/(2*$1)) t '      IH'  w l lt 1 lc rgb 'red' lw 1
...
plot \
'rslt_P20V5R12Y5/data/events_nh_50_0.dat' u ($1**2+0.8):($2/(2*$1)) t '50 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'rslt_P20V5R12Y5/data/events_ih_50_0.dat' u ($1**2+0.8):($2/(2*$1)) t '      IH'  w l lt 1 lc rgb 'red' lw 1
...
plot \
'rslt_P20V5R12Y5/data/events_nh_60_0.dat' u ($1**2+0.8):($2/(2*$1)) t '60 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'rslt_P20V5R12Y5/data/events_ih_60_0.dat' u ($1**2+0.8):($2/(2*$1)) t '      IH'  w l lt 1 lc rgb 'red' lw 1
