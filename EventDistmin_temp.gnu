...
'events_ihmin_LLL_6.dat' u ($1**2+0.8):($2/(2*$1)) notitle  w l lt 2 lc rgb 'green' lw 0 ,\
'events_ihmin_LLL_3.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 3 lc rgb 'green' lw 0 ,\
'events_ihmin_LLL_1.5.dat' u ($1**2+0.8):($2/(2*$1)) t 'Best fit to NH data (1.5%)' w l lt 1 lc rgb 'blue' lw 1 ,\
