...
set multiplot
plot \
'rslt_naive/data/FluxXsec_loe_100.dat' u 1:2 t 'No Oscillation' w l lt 2 lc rgb 'red' lw 3 ,\
'rslt_naive/data/FluxXsecPeeNH_loe_100.dat' u 1:2 t 'NH' w l lt 1 lc rgb 'red' lw 3 ,\
'rslt_naive/data/FluxXsecPeeIH_loe_100.dat' u 1:2 t 'IH' w l lt 1 lc rgb 'blue' lw 3
set nomultiplot
...
set multiplot
plot \
'rslt_naive/data/PeeNH_loe_100.dat' u 1:2 t 'NH' w l lt 1 lc rgb 'red' lw 3 ,\
'rslt_naive/data/PeeIH_loe_100.dat' u 1:2 t 'IH' w l lt 1 lc rgb 'blue' lw 3
set nomultiplot
