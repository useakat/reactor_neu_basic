...
set output "plots/EventDistmin_fit2ih_0_0_100.eps"
...
set multiplot
plot \
'rslt_test/data/events_nh_100_0_0.dat' u ($1**2+0.8):($2/(2*$1)) t 'NH' w l lt 2 lc rgb 'blue' lw 3 ,\
'rslt_test/data/events_ih_100_0_0.dat' u ($1**2+0.8):($2/(2*$1)) t 'IH' w l lt 2 lc rgb 'red' lw 3 ,\
'rslt_test/data/events_ihmin_100_0_0.dat' u ($1**2+0.8):($2/(2*$1)) t 'Best fit to IH data (0 %)' w l lt 1 lc rgb 'blue' lw 1
set nomultiplot
