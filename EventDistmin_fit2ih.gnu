...
set output "plots/EventDistmin_fit2ih_100.eps"
...
set multiplot
plot \
'events_nh_100_6.dat' u ($1**2+0.8):($2/(2*$1)) t 'NH' w l lt 2 lc rgb 'red' lw 3 ,\
'events_ih_100_6.dat' u ($1**2+0.8):($2/(2*$1)) t 'IH' w l lt 2 lc rgb 'blue' lw 3 ,\
'events_ihmin_100_6.dat' u ($1**2+0.8):($2/(2*$1)) t 'Best fit to IH data (6%)' w l lt 1 lc rgb 'red' lw 1
set nomultiplot
