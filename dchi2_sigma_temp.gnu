...
set multiplot
plot \
'DATADIR/dchi2_cl_nh_2_0.5.dat' every::0::7 u (sqrt($1)):(1-$3):(sqrt($1-$3)):(sqrt($1+$3)):(1-($3+$4)):(1-($3-$4)) t '(a, b) = (2, 0.5): NH'  w xyerrorbars pointtype 7 lt 1 lc rgb 'red' lw 3 ,\
'DATADIR/dchi2_cl_nh_2_0.5.dat' every::0::7 u (sqrt($1)):(1-$3) notitle  w l lt 1 lc rgb 'red' lw 3 ,\
'DATADIR/dchi2_cl_ih_2_0.5.dat' every::0::7 u (sqrt($1)):(1-$3):(sqrt($1-$3)):(sqrt($1+$3)):(1-($3+$4)):(1-($3-$4)) t '                   IH'  w xyerrorbars pointtype 6 lt 2 lc rgb 'red' lw 3 ,\
'DATADIR/dchi2_cl_ih_2_0.5.dat' every::0::7 u (sqrt($1)):(1-$3) notitle  w l lt 2 lc rgb 'red' lw 3 ,\
'DATADIR/dchi2_cl_nh_3_0.75.dat' every::0::7 u (sqrt($1)):(1-$3):(sqrt($1-$3)):(sqrt($1+$3)):(1-($3+$4)):(1-($3-$4)) t '        (3, 0.75): NH'  w xyerrorbars pointtype 5 lt 1 lc rgb 'blue' lw 3 ,\
'DATADIR/dchi2_cl_nh_3_0.75.dat' every::0::7 u (sqrt($1)):(1-$3) notitle  w l lt 1 lc rgb 'blue' lw 3 ,\
'DATADIR/dchi2_cl_ih_3_0.75.dat' every::0::7  u (sqrt($1)):(1-$3):(sqrt($1-$3)):(sqrt($1+$3)):(1-($3+$4)):(1-($3-$4)) t '                   IH'  w xyerrorbars pointtype 4 lt 2 lc rgb 'blue' lw 3 ,\
'DATADIR/dchi2_cl_ih_3_0.75.dat' every::0::7 u (sqrt($1)):(1-$3) notitle  w l lt 2 lc rgb 'blue' lw 3 ,\
