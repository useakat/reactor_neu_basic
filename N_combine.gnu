...
unset title
set title '{/=20 16.52GW_{th}, 10kton (12.00% proton), 5 years, {/Symbol=\144}E_{vis}/E_{vis} = 3%/{/Symbol=\326}E_{vis}}'
set size 1,1.07
...
plot \
'rslt_naive/data/N_nh_30.dat' u 1:2 t '30 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'rslt_naive/data/N_ih_30.dat' u 1:2 t '      IH'  w l lt 1 lc rgb 'red' lw 1
...
plot \
'rslt_naive/data/N_nh_40.dat' u 1:2 t '40 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'rslt_naive/data/N_ih_40.dat' u 1:2 t '      IH'  w l lt 1 lc rgb 'red' lw 1
...
plot \
'rslt_naive/data/N_nh_50.dat' u 1:2 t '50 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'rslt_naive/data/N_ih_50.dat' u 1:2 t '      IH'  w l lt 1 lc rgb 'red' lw 1
...
plot \
'rslt_naive/data/N_nh_60.dat' u 1:2 t '60 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'rslt_naive/data/N_ih_60.dat' u 1:2 t '      IH'  w l lt 1 lc rgb 'red' lw 1
