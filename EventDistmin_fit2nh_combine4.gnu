...
set output "plots/EventDistmin_fit2nh_combine_50_0_0.eps"
...
set label '(a, b) = (0, 0)%' at graph 0.05, graph 0.9
plot \
'rslt_test2/data/events_nh_50_0_0.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 2 lc rgb 'blue' lw 3 ,\
'rslt_test2/data/events_ih_50_0_0.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 2 lc rgb 'red' lw 3 ,\
'rslt_test2/data/events_nhmin_50_0_0.dat' u ($1**2+0.8):($2/(2*$1)) notitle w l lt 1 lc rgb '#006400' lw 2
