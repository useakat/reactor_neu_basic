...
set label '{/Symbol=\264}16' at 10,0.0000015 tc rgb 'red'
...
set label '{/Symbol=\264}16' at 5,0.0016 tc rgb 'blue'
set label '{/Symbol=\264}25' at 6.85,0.00006 tc rgb 'blue'
set label '{/Symbol=\264}125' at 8.5,0.0000015 tc rgb 'blue'
set xrange [0:11]
set yrange [1E-7:2]
set pointsize 1.2
set multiplot
plot \
'rslt_1000pt/data/dchi2_cl_nh_2_0.5.dat' every::1::7 u (sqrt($1)):(1-$3):(sqrt($1-$3)):(sqrt($1+$3)):(1-($3+$4)):(1-($3-$4)) t '(a, b) = (2, 0.5): NH'  w xyerrorbars pointtype 7 lt 1 lc rgb 'red' lw 3 ,\
'rslt_1000pt/data/dchi2_cl_nh_2_0.5.dat' every::1::7 u (sqrt($1)):(1-$3) notitle  w l lt 1 lc rgb 'red' lw 3 ,\
'rslt_1000pt/data/dchi2_cl_ih_2_0.5.dat' every::1::7 u (sqrt($1)):(1-$3):(sqrt($1-$3)):(sqrt($1+$3)):(1-($3+$4)):(1-($3-$4)) t '                   IH'  w xyerrorbars pointtype 6 lt 2 lc rgb 'red' lw 3 ,\
'rslt_1000pt/data/dchi2_cl_ih_2_0.5.dat' every::1::7 u (sqrt($1)):(1-$3) notitle  w l lt 2 lc rgb 'red' lw 3 ,\
'rslt_1000pt/data/dchi2_cl_nh_3_0.75.dat' every::1::7 u (sqrt($1)):(1-$3):(sqrt($1-$3)):(sqrt($1+$3)):(1-($3+$4)):(1-($3-$4)) t '        (3, 0.75): NH'  w xyerrorbars pointtype 5 lt 1 lc rgb 'blue' lw 3 ,\
'rslt_1000pt/data/dchi2_cl_nh_3_0.75.dat' every::1::7 u (sqrt($1)):(1-$3) notitle  w l lt 1 lc rgb 'blue' lw 3 ,\
'rslt_1000pt/data/dchi2_cl_ih_3_0.75.dat' every::1::7  u (sqrt($1)):(1-$3):(sqrt($1-$3)):(sqrt($1+$3)):(1-($3+$4)):(1-($3-$4)) t '                   IH'  w xyerrorbars pointtype 4 lt 2 lc rgb 'blue' lw 3 ,\
'rslt_1000pt/data/dchi2_cl_ih_3_0.75.dat' every::1::7 u (sqrt($1)):(1-$3) notitle  w l lt 2 lc rgb 'blue' lw 3 ,\
'rslt_1000pt/data/dchi2_cl_nostat.dat' u (sqrt($1)):(1-$2) t 'No Fluctuation'  w l lt 1 lc rgb 'black' lw 5 ,\
