...
set multiplot
plot \
'noosc.dat' u 1:($2*20) notitle  w l lt 1 lc rgb 'red' lw 3
set nomultiplot
...
set title "P_{reactor} = 20GW_{th}, V = 5kton (5% free proton), 5 years, NH, {/Symbol=\144}E_{vis}/E_{vis} = 6%/{/Symbol=\326}E_{vis}"
set xlabel 'Ev [MeV]' offset -1,0
