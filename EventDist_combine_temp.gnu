...
plot \
'events_nh_30_ERES.dat' u ($1**2+0.8):($2/(2*$1)) t '30 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'events_ih_30_ERES.dat' u ($1**2+0.8):($2/(2*$1)) t '      IH'  w l lt 1 lc rgb 'red' lw 1
...
plot \
'events_nh_40_ERES.dat' u ($1**2+0.8):($2/(2*$1)) t '40 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'events_ih_40_ERES.dat' u ($1**2+0.8):($2/(2*$1)) t '      IH'  w l lt 1 lc rgb 'red' lw 1
...
plot \
'events_nh_50_ERES.dat' u ($1**2+0.8):($2/(2*$1)) t '50 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'events_ih_50_ERES.dat' u ($1**2+0.8):($2/(2*$1)) t '      IH'  w l lt 1 lc rgb 'red' lw 1
...
plot \
'events_nh_60_ERES.dat' u ($1**2+0.8):($2/(2*$1)) t '60 km NH'  w l lt 1 lc rgb 'blue' lw 1 ,\
'events_ih_60_ERES.dat' u ($1**2+0.8):($2/(2*$1)) t '      IH'  w l lt 1 lc rgb 'red' lw 1
