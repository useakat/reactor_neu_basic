...
set output "plots/EventDistmin_fit2ih_ERES_ERESNL_LLL.eps"
...
'DATADIR/events_ihmin_LLL_ERES_ERESNL.dat' u ($1**2+0.8):($2/(2*$1)) t 'Best fit to IH data (ERES %)' w l lt 1 lc rgb 'blue' lw 1
set nomultiplot
